...
const Footer: React.FC = () => {
    return (
        ...
        >
            <div className='max-w-7xl mx-auto text-sm bg-primary py-5 px-5'>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="#careers" className="hover:underline text-secondary">
                                    Careers
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <Link href="#" aria-label="Twitter" className="flex items-center justify-center text-xl text-secondary hover:text-accent">
                                <FaSquareXTwitter aria-hidden />
                            </Link>
                            <Link href="#" aria-label="Discord" className="flex items-center justify-center text-xl text-secondary hover:text-accent">
                                <FaDiscord aria-hidden />
                            </Link>
                            <Link href="#" aria-label="LinkedIn" className="flex items-center justify-center text-xl text-secondary hover:text-accent">
                                <FaLinkedin aria-hidden />
                            </Link>
                            <Link href="#" aria-label="GitHub" className="flex items-center justify-center text-xl text-secondary hover:text-accent">
                ...
                <p className="text-xs text-muted mt-5 text-center">
                    © {new Date().getFullYear()} Halo - For the future
                </p>
            </div>
        </footer>
    )
